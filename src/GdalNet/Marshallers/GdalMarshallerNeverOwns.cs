...
[CustomMarshaller(typeof(CustomMarshallerAttribute.GenericPlaceholder), MarshalMode.ManagedToUnmanagedIn, typeof(GdalMarshallerNeverOwns<,>.ManagedToUnmanagedIn))]
[CustomMarshaller(typeof(CustomMarshallerAttribute.GenericPlaceholder), MarshalMode.ManagedToUnmanagedRef, typeof(GdalMarshallerNeverOwns<,>.ManagedToUnmanagedRef))]
[CustomMarshaller(typeof(CustomMarshallerAttribute.GenericPlaceholder), MarshalMode.ManagedToUnmanagedOut, typeof(GdalMarshallerNeverOwns<,>.ManagedToUnmanagedOut))]
internal static class GdalMarshallerNeverOwns<TWrapper, THandle>
    where THandle : GdalInternalHandle.NeverOwns, IConstructableHandleNeverOwns<THandle>
