...
[CustomMarshaller(typeof(CustomMarshallerAttribute.GenericPlaceholder), MarshalMode.ManagedToUnmanagedRef, typeof(GdalDoesntOwnMarshaller<,>.ManagedToUnmanagedRef))]
[CustomMarshaller(typeof(CustomMarshallerAttribute.GenericPlaceholder), MarshalMode.ManagedToUnmanagedOut, typeof(GdalDoesntOwnMarshaller<,>.ManagedToUnmanagedOut))]
public static class GdalDoesntOwnMarshaller<TWrapper, THandle>
    ...
    where TWrapper : class, IHasHandle<THandle>, IConstructableWrapper<TWrapper, THandle>
{
    ...
    public struct ManagedToUnmanagedRef
    {
        ...
        public TWrapper? ToManagedFinally() => _handleToReturn is not null && _handleToReturn.IsInvalid == false ? TWrapper.Construct(_handleToReturn!): null;
